...
class _BotaoSalvarState extends State<BotaoSalvar> {
  salvar() {
    ...
    cargos
      ...
      q.docs.forEach((element) {
        ...
        faixas.orderBy('final_intervalo').get().then((QuerySnapshot q) {
          ...
          /*print(keyTabela
                .currentState!.widget.textEditingIntervalos[contar].length);
                print(keyTabela
                .currentState!.widget.textEditingValores[contar].length);*/
    ...
    if (verificador_vazios == true) {
      ...
      if(verificador_alteracao==false && keyTabela.currentState!.widget.adicionados.isEmpty && keyTabela.currentState!.widget.deletados.isEmpty){
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        backgroundColor: Colors.red,

...
class TabletCargos extends StatefulWidget {
  List<Cargo> cargos;
  String instituicao;
  ...
  TabletCargos({Key? key,required this.cargos,required this.instituicao}) : super(key: key);

  @override
  State<TabletCargos> createState() => _TabletCargosState();
}

class _TabletCargosState extends State<TabletCargos> {
  @override
